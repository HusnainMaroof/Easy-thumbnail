        ...
        {showLoginPopup && (
          <div className="fixed  inset-0 z-200 flex items-center justify-center p-4 bg-black/10 backdrop-blur-sm min-h-screen">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md max-h-[95vh] overflow-y-auto custom-scrollbar bg-white border-[6px] border-black rounded-[2.5rem] shadow-[15px_15px_0px_0px_rgba(0,0,0,1)] p-8 md:p-10 "
            >
              {/* CLOSE BUTTON */}
              <button
                onClick={() => setShowLoginPopup(false)}
